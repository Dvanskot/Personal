...
<p></p>
<p> </p>
<table width="59%" border="0" align="center" class="table table-bordered">
<?php
if (!isset($_SESSION['user'])) {
...
if (count($books) > 0) {
	...
	?>
		...
		<td height="231">
			...
			<p><a href="product.php?book=<?php echo $book->getId(); ?>"><h3><?php echo $book->getName(); ?></h3></a>
...
<table width="84%" border="0" align="center" class="table table-bordered">
  <tr class="info">
