...
<table width="55%" border="0" align="center" class="table">
<?php
...
<table class="table table-bordered" width="100%" border="0">
    ...
    <tr class="info"><td height="194"><a href="product.php?book=<?php echo $book->getId(); ?>"><h3><?php echo $book->getName(); ?></h3></a>
...
<table class="table table-bordered" width="100%" border="0">
    ...
    <tr class="info"><td height="80"><a href="catalogue.php?category=<?php echo $category->getId(); ?>">
      <h3><?php echo $category->getName() . ' ('. $manager->getTotalProductsPerCategory($category->getId()) . ')'; ?></h3>
    </a></p>
